...
export const ExperienceSection = forwardRef<HTMLElement>((_props, ref) => (
  <Section title="Últimas Experiências Profissionais" color="black" backgroundColor="white" ref={ref}>
    <ContentWrapper>
      <FadeIn from="bottom" offsetPosition={400} offsetTrigger={300} delay={0}>
        <ExperienceCard
          ...
          skills={['Software (JS/TS, Python)', 'Computação em nuvem (GCP / AWS)', 'Dados: Mongo, Redis e Bigquery']}
        />
      </FadeIn>
      <FadeIn from="bottom" offsetPosition={400} offsetTrigger={300} delay={200}>
        <ExperienceCard
          ...
          skills={['Firmware em C / C++', 'Scripts em Python', 'Software em JS / TS e C++ (Qt)']}
        />
      </FadeIn>
      <FadeIn from="bottom" offsetPosition={400} offsetTrigger={300} delay={400}>
        <ExperienceCard
          ...
          skills={['Drivers C / C++', 'Software em Python com GUI', 'Processamento distr. de dados']}
        />
      </FadeIn>
    </ContentWrapper>
  </Section>
